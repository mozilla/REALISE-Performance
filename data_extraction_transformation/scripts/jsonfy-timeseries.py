...
input_folder = 'datasets-original-annotated-2-aggregated-min'
dest_folder = 'datasets-original-annotated-2-aggregated-min-json'

df_alerts = pd.read_csv('../datasets/2_rectified_alerts_data.csv', index_col=False)
projects_folders = ["autoland1", "autoland2", "autoland3", "autoland4", "firefox-android", "mozilla-beta"]
