...
def process_folder(folder):
    for signature_file in os.listdir('../datasets/' + folder):
        ...
        df = pd.read_csv('../datasets/' + folder + '/' + signature_file, index_col=False)[columns]
        ...
        df_final.loc[df_final['test_manually_created'] == True, 'alert_status'] = "FN"
...
projects_folders_mapping = {"autoland": ["autoland1", "autoland2"]}
